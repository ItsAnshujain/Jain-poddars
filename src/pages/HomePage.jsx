        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          >
            <p className="text-gray-700 text-md leading-relaxed text-justify">
                ...
                We are a leading firm of Chartered Accountants based at Ranchi
                and Ramgarh providing a plethora of services relating to
                Taxation, Audit, Accounting, Corporate Matters, Finance, and
                Consultancy. We are specialized in Income Tax Consultancy, GST
                Consultancy, Statutory and Internal Audits, Project Financing
                and Project Consultancy, Preparation and Presentation of
                Projected Financial Statements, Corporate Law Matters, Financial
                and Tax Planning, Management Consultancy services, etc.
              </p>
              ...
              <p className="text-gray-700 text-md mt-2 leading-relaxed text-justify">
                Our work style is that of partnering change, and we play the
                role of a facilitator. In this process, we work with our clients
                to augment internal resources and strengthen capabilities.
              </p>
              <p className="text-gray-700 text-md mt-2 leading-relaxed text-justify">
                Our objective is to ensure quality service and unquestioned
                integrity in our work methods. We try and evolve alternatives
                that are customized, practical, unique, and foresighted.
              </p>
              <p className="text-gray-700 text-md mt-2 leading-relaxed text-justify">
                To a large extent, this is due to the fact that we have access
                to the expertise that is available at different places but is
